...
set.seed(111110)
ha = HeatmapAnnotation(df = data.frame(Data = c(rep("TOF", 23), rep("Control", 24))), col = list(Data = c("TOF" = "red4", "Control"="blue4")))
...
ht_list = Heatmap(meth.AUC, clustering_method_columns = "ward.D2", name = "Methylation", col = colorRamp2(c(0, 0.1, 0.2, 0.4, 0.5, 0.6, 0.8, 1), c("green4","lightseagreen","aquamarine4", "violet","violetred3","red", "firebrick4","red4")),
  ...
  Heatmap(annotation, name = "Probe Annotation", col = c("TSS1500" = "red4", "TSS200" = "darkorchid4", "1stExon"="violetred3", "Body"="blue4", "3'UTR"="green4", "5'UTR"="darkslateblue"), column_names_gp = gpar(fontsize = 8))
  #Heatmap(relation1, name = "Probe Relationship", column_names_gp = gpar(fontsize = 8))
pdf("TOF75-Methylation-AUC_1.pdf", width = 10, height = 10)
