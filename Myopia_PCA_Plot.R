...
TableInput <- fread(input = "HM new Individual data-Feb 15 2018.txt")
...
ggplot(PCi,aes(x=PC1,y=PC2, col=Sample))+
  ...
  theme_classic()
ggsave("PCA Myopia .pdf", dpi = 600, width = 5, height = 5)
...
dev.print(pdf, 'PCA Myopia 3D.pdf', width = 8, height = 8)

#####################
save.image("Myopia_PCA_Plot.RData")
