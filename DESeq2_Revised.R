...
## Write results
write.csv(resdata, file="NOS_Vs_Ctr_diffexpr-results.csv")

resdata_0.05 <- resdata[(abs(resdata$log2FoldChange)> 1 & resdata$padj <= 0.05) ,]
write.csv(resdata_0.05, file="NOS_Vs_Ctr_diffexpr_log2FC_1.0_FDR_0.05.csv")

resdata_0.01 <- resdata[(abs(resdata$log2FoldChange)> 1.5 & resdata$padj <= 0.01) ,]
write.csv(resdata_0.01, file="NOS_Vs_Ctr_diffexpr_log2FC_1.5_FDR_0.01.csv")
...
save.image("NAS_Vs_Normal.RData")
